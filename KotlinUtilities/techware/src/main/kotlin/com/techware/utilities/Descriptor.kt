...
//        sb.appendln("\"")
        ...
        fun generateClassFromString(descriptorStr: String, className: String): String {
            val typeList2 = convertDescriptorToTypeList(descriptorStr)

            return generateClassFromString(typeList2, className)
        }

        fun generateClassFromList(descriptor: List<String>, className: String): String {
            val typeList2 = convertDescriptorToTypeList(descriptor)
