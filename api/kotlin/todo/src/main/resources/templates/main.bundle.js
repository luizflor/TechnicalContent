...
var LogginComponent = (function () {
    function LogginComponent(todoService) {
        this.todoService = todoService;
    ...
    LogginComponent.prototype.onLoggin = function () {
        ...
        this.todoService.loggin(this.user).subscribe(function (data) {
            ...
            _this.todoService.setToken(new __WEBPACK_IMPORTED_MODULE_3__model_Token__["a" /* Token */](token));
        }, function (e) {
            //alert(e);
...
var TODO_ROUTES = [
    ...
    { path: 'delete', component: __WEBPACK_IMPORTED_MODULE_3__delete_delete_component__["a" /* DeleteComponent */] },
    { path: 'update', component: __WEBPACK_IMPORTED_MODULE_4__update_update_component__["a" /* UpdateComponent */] },
    { path: 'retrieve', component: __WEBPACK_IMPORTED_MODULE_5__retrieve_retrieve_component__["a" /* RetrieveComponent */] },
    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_6__loggin_loggin_component__["a" /* LogginComponent */] },
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forRoot(TODO_ROUTES);
...
var TodoService = (function () {
    ...
    TodoService.prototype.setToken = function (token) {
        ...
        var tokenParse = (__WEBPACK_IMPORTED_MODULE_4_jwt_decode__(token.token));
...
var TokenComponent = (function () {
    function TokenComponent(todoService) {
        this.todoService = todoService;
    ...
    TokenComponent.prototype.onSetToken = function () {
        ...
        // const expirationSeconds = (new Date(token.exp * 1000).getTime() - new Date().getTime()) / 1000;
        // console.log(expirationSeconds, userName);
        this.todoService.setToken(this.token);
    };
